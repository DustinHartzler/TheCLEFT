...
class IT_Exchange_Product_Feature_Purchase_Buttons extends IT_Exchange_Product_Feature_Abstract {
	...
	*/
	function print_metabox( $post ) {
		...
		// Set description
		$description = __( 'Use the below settings to determine which purchase buttons are available for this product.', 'it-l10n-exchange-addon-purchase-buttons' );
				...
				<div class="it-exchange-core-product-purchase-buttons-fields">
					<div class="it-exchange-product-purchase-buttons-field">
						<label for="it-exchange-product-purchase-buttons-disable-buy-now">
							<?php _e( 'Buy Now button', 'it-l10n-exchange-addon-purchase-buttons' ); ?>
						</label>
						<select id="it-exchange-product-purchase-buttons-buy-now" name="it-exchange-product-purchase-buttons[buy-now]"> 
							<option value="default" <?php selected( 'default', $buy_now ); ?>><?php _e( 'Use the default setting', 'it-l10n-exchange-addon-purchase-buttons' ); ?></option>
							<option value="always" <?php selected( 'always', $buy_now ); ?>><?php _e( 'Always display', 'it-l10n-exchange-addon-purchase-buttons' ); ?></option>
							<option value="never" <?php selected( 'never', $buy_now ); ?>><?php _e( 'Never display', 'it-l10n-exchange-addon-purchase-buttons' ); ?></option>
						</select>
					</div>
					<div class="it-exchange-product-purchase-buttons-field">
						<label for="it-exchange-product-purchase-buttons-disable-add-to-cart">
							<?php _e( 'Add to Cart button', 'it-l10n-exchange-addon-purchase-buttons' ); ?>
						</label>
						<select id="it-exchange-product-purchase-buttons-add-to-cart" name="it-exchange-product-purchase-buttons[add-to-cart]"> 
							<option value="default" <?php selected( 'default', $add_to_cart ); ?>><?php _e( 'Use the default setting', 'it-l10n-exchange-addon-purchase-buttons' ); ?></option>
							<option value="always" <?php selected( 'always', $add_to_cart ); ?>><?php _e( 'Always display', 'it-l10n-exchange-addon-purchase-buttons' ); ?></option>
							<option value="never" <?php selected( 'never', $add_to_cart ); ?>><?php _e( 'Never display', 'it-l10n-exchange-addon-purchase-buttons' ); ?></option>
						</select>
					</div>
				</div>
...
$purchase_buttons_product_feature_options = array(
	...
	'metabox_title' => __( 'Purchase Buttons', 'it-l10n-exchange-addon-purchase-buttons' ),
	'description'   => __( 'Which purchase buttons are available for this product', 'it-l10n-exchange-addon-purchase-buttons' ),
