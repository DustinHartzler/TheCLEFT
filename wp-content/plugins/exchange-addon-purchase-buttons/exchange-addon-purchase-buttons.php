...
function it_exchange_register_purchase_buttons_addon() {
	$options = array(
		'name'              => __( 'Purchase Buttons', 'it-l10n-exchange-addon-purchase-buttons' ),
		'description'       => __( 'Allows you to customize which purchase buttons are available for what products.', 'it-l10n-exchange-addon-purchase-buttons' ),
		'author'            => 'iThemes',
...
function it_exchange_purchase_buttons_set_textdomain() {
	load_plugin_textdomain( 'it-l10n-exchange-addon-purchase-buttons', false, dirname( plugin_basename( __FILE__  ) ) . '/lang/' );
}
