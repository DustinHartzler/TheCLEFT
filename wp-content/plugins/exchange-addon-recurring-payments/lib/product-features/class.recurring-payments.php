...
class IT_Exchange_Recurring_Payments {
	...
	*/
	function register_metabox() {
		add_meta_box( 'it-exchange-recurring-payments', __( 'Recurring Payments', 'it-l10n-exchange-addon-recurring-payments' ), array( $this, 'print_metabox' ), 'it_exchange_prod', 'it_exchange_normal', 'high' );
	}
	...
	*/
	function print_metabox( $post ) {
		...
		$recurring_options = array(
			'forever'   => __( 'Forever', 'it-l10n-exchange-addon-recurring-payments' ),
			'monthly'   => __( 'Monthly', 'it-l10n-exchange-addon-recurring-payments' ),
			'yearly'    => __( 'Yearly', 'it-l10n-exchange-addon-recurring-payments' ),
		);
		...
		?>
            ...
            <span class="it-exchange-recurring-payment-auto-renew <?php echo $hidden; ?> auto-renew-<?php echo $product_feature_auto_renew; ?>" title="<?php printf( __( 'Auto-Renew: %s', 'it-l10n-exchange-addon-recurring-payments' ), strtoupper( $product_feature_auto_renew ) ); ?>">
